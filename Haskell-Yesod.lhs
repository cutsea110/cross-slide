...
<html><head><title></title><style>.message{color:red;}li{list-style-type:none;}</style></head>
...
- Very active, firendly community, lots of them making sites too.
